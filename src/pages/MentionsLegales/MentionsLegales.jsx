...
export function MentionsLegales() {
  return (
    <>
      <Helmet>
        <title>Mentions Légales — 7Artisan</title>
        <meta
          name="description"
          content="Mentions légales du site 7Artisan, artisan qualifié spécialisé en rénovation à Limoges."
        />
        <link rel="canonical" href="https://7artisan.fr/mentions-legales" />
      </Helmet>
      <main className="mentions-legales">
        ...
        <section>
          ...
          <p>Le directeur de la publication est le gérant de 7Artisan.</p>
        </section>
        <section>
          <h2>Hébergement</h2>
        ...
        <section>
          ...
          <p>
            ...
            est la propriété exclusive de 7Artisan et est protégé par les lois
        ...
        <section>
          ...
          <p>
            ...
            cédées ni vendues à des tiers. Conformément au RGPD, vous disposez
            d'un droit d'accès, de rectification et de suppression de vos
            données en nous contactant à : 7artisan87100@gmail.com
          </p>
        </section>
        <section>
          <h2>Cookies</h2>
          <p>
            ...
            cookies techniques peuvent être utilisés pour assurer le bon
        ...
        <section>
          ...
          <p>
            7Artisan s'efforce de maintenir les informations de ce site à jour
            et exactes. Cependant, nous ne pouvons garantir l'exactitude, la
